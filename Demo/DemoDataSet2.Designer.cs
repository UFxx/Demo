...
namespace Demo {
    ...
    public partial class DemoDataSet2 : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductsRow AddProductsRow(string ProductDescription, string ProductName, string ProductCategory) {
...
namespace Demo.DemoDataSet2TableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Products] WHERE (([ID_product] = @Original_ID_product) AND ((@IsNull_ProductDescription = 1 AND [ProductDescription] IS NULL) OR ([ProductDescription] = @Original_ProductDescription)) AND ((@IsNull_ProductName = 1 AND [ProductName] IS NULL) OR ([ProductName] = @Original_ProductName)) AND ((@IsNull_ProductCategory = 1 AND [ProductCategory] IS NULL) OR ([ProductCategory] = @Original_ProductCategory)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Products] ([ProductDescription], [ProductName], [ProductCategory]) VALUES (@ProductDescription, @ProductName, @ProductCategory);
SELECT ID_product, ProductDescription, ProductName, ProductCategory FROM Products WHERE (ID_product = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [ProductDescription] = @ProductDescription, [ProductName] = @ProductName, [ProductCategory] = @ProductCategory WHERE (([ID_product] = @Original_ID_product) AND ((@IsNull_ProductDescription = 1 AND [ProductDescription] IS NULL) OR ([ProductDescription] = @Original_ProductDescription)) AND ((@IsNull_ProductName = 1 AND [ProductName] IS NULL) OR ([ProductName] = @Original_ProductName)) AND ((@IsNull_ProductCategory = 1 AND [ProductCategory] IS NULL) OR ([ProductCategory] = @Original_ProductCategory)));
SELECT ID_product, ProductDescription, ProductName, ProductCategory FROM Products WHERE (ID_product = @ID_product)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID_product, ProductDescription, ProductName, ProductCategory FROM dbo.Prod" +
                "ucts";
        ...
        public virtual int Fill(DemoDataSet2.ProductsDataTable dataTable) {
        ...
        public virtual DemoDataSet2.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DemoDataSet2.ProductsDataTable dataTable = new DemoDataSet2.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DemoDataSet2.ProductsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID_product, string Original_ProductDescription, string Original_ProductName, string Original_ProductCategory) {
        ...
        public virtual int Insert(string ProductDescription, string ProductName, string ProductCategory) {
        ...
        public virtual int Update(string ProductDescription, string ProductName, string ProductCategory, int Original_ID_product, string Original_ProductDescription, string Original_ProductName, string Original_ProductCategory, int ID_product) {
            if ((ProductDescription == null)) {
            ...
            if ((Original_ProductDescription == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_ProductDescription));
            }
            if ((Original_ProductName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductDescription, string ProductName, string ProductCategory, int Original_ID_product, string Original_ProductDescription, string Original_ProductName, string Original_ProductCategory) {
            return this.Update(ProductDescription, ProductName, ProductCategory, Original_ID_product, Original_ProductDescription, Original_ProductName, Original_ProductCategory, Original_ID_product);
        }
    }
